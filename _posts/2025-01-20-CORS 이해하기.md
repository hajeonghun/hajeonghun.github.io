...
- **\<iframe src="…">**
  - 외부 웹사이트를 로드할 수 있습니다.
    - e.g., www.a.com 에서 www.b.com을 iframe으로 로드
  - `X-Frame-Options` 헤더는 외부 출처로 포함된 페이지를 차단할 수 있습니다.
